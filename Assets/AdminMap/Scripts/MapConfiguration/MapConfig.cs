...
public class MapConfig : MonoBehaviour
{
    ...
    public MapConfig()
    {
        tileConfigs.Add(new TileConfig(TileType.Grass, State.Off, Vector2.down, GameObjectType.Flower));
        placeableObjectConfigs.Add(new ObjectConfig(GameObjectType.TrashBin, 2.0f, 3.0f));
    }
