...
public class Map : MonoBehaviour
{
        ...
        for (int i = 0; i < mapSize; i++)
        {
            for (int j = 0; j < mapSize; j++)
            {
                if ((i == 2 || i == 3) && (j == 2 || j == 3) || ((i == 3 || i == 4) && (j == 4 || j == 5))
                                                             || (i == 45 && j < 50 && j > 43) || (j == 43 && i > 45 && i < 50) || (i == 45 && j == 43)
                                                             || ((i == 28 || i == 29 || i == 30) && (j == 23 || j == 24 || j == 25)))
                {
                    tiles[i, j] = Instantiate(waterTilePrefab, grid.GetTransform(i, j));
                         ...
                         || (i == 35 && j < 10 && j >= 0) || (j == 6 && i > 35 && i < 40) || (j == 5 && (i > 16 && i < 25))
                         || (i == 33 && (j > 10 && j < 20)))
    ...
    {
        if (checkIfZoneSizeIsEvenNumber())
        {
    ...
    public bool checkIfZoneSizeIsEvenNumber()
    {
        if (zoneSize % 2 == 0)
        {
            return true;
